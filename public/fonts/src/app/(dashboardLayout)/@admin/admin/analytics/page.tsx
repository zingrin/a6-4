      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat, index) => {
          ...
          return (
            <Card
              key={index}
              className="border-none shadow-sm hover:shadow-md transition-all duration-300 bg-card/50 backdrop-blur-sm"
            >
        ...
        <Card className="border-none shadow-sm bg-indigo-600 text-white overflow-hidden relative">
          ...
          <CardContent>
            <p className="text-sm text-indigo-100 leading-relaxed">
              Student registrations are up by 12% this month. The most popular
              sector continues to be Web Development and AI.
            </p>
        ...
        <Card className="border-none shadow-sm bg-card/50 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground italic">
              Platform efficiency measures successfully completed sessions
              against total bookings.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-sm bg-card/50 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed font-medium pt-2 border-t">
              Aggregated revenue from all course enrollments and professional
              tutoring sessions.
            </p>
          </CardContent>
        </Card>
