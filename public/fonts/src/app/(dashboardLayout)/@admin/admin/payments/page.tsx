...
export default async function AdminPaymentsPage({
  ...
  const recentVolume = completedPayments.reduce(
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border-none shadow-sm bg-indigo-600 text-white overflow-hidden relative">
          <CardHeader className="pb-2">
            <CardTitle className="text-xs font-bold uppercase tracking-widest text-indigo-200">
              Total Volume
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-[10px] text-indigo-200 mt-1 font-medium">
              Estimated gross platform volume
            </p>
        ...
        <Card className="border-none shadow-sm bg-card/50 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-muted-foreground mt-1 font-medium">
              Transaction completion rate this page
            </p>
        ...
        <Card className="border-none shadow-sm bg-card/50 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-muted-foreground mt-1 font-medium">
              Verified platform events recorded
            </p>
          </CardContent>
        </Card>
      </div>
