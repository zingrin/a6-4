        ...
        <Card className="lg:col-span-8 overflow-hidden border-none shadow-md bg-card/50 backdrop-blur-sm">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link
              ...
              className="text-xs text-primary hover:underline flex items-center gap-1 font-medium bg-primary/5 px-3 py-1.5 rounded-md transition-all"
            >
            ...
            {recentCourses.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center space-y-3 bg-muted/20 rounded-xl border border-dashed">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Start building your catalog to see insights here.
                  </p>
                </div>
              ...
              <div className="space-y-3">
                {recentCourses.map((course: any) => (
                  <div
                    key={course.id}
                    className="group flex items-center gap-4 p-4 border border-transparent hover:border-border/50 bg-background/50 hover:bg-background/80 rounded-xl transition-all duration-300"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          ...
                          className="text-[10px] px-1.5 h-4 font-bold uppercase tracking-tighter"
                        >
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl text-white shadow-lg shadow-indigo-500/20">
              ...
              <p className="text-xs text-white/80 leading-relaxed mb-4">
                Expand your reach by inviting more expert mentors and launching
                new industry-focused programs.
              </p>
            ...
            <div className="space-y-2">
              <h5 className="text-xs font-bold text-muted-foreground uppercase tracking-widest px-1">
                Management
              </h5>
              <Link
