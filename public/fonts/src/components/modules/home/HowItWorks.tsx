          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="relative z-10 mb-6">
                <div className="w-20 h-20 rounded-full border-3 border-white flex items-center justify-center relative">
                  <Image
                    ...
                    aria-selected={false}
                  />
                  <span className="text-primary text-3xl font-bold absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    {step.number}
                  </span>
                </div>
              </div>
              ...
              <div className="text-center md:text-left">
                <h3 className="text-xl font-bold mb-3 text-accent-foreground">
                  {step.title}
                </h3>
