...
export const categoryService = {
  ...
  updateCategory: async (
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/categories/update/${categoryId}`,
        {
          method: "PUT",
          headers: {
            Cookie: cookieStore.toString(),
  ...
  updateSubject: async (subjectData: Partial<Subject>, subjectId: string) => {
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/categories/update/subject/${subjectId}`,
        {
          method: "PUT",
          headers: {
            Cookie: cookieStore.toString(),
  ...
  deleteCategory: async (categoryId: string) => {
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/categories/delete/${categoryId}`,
        {
          method: "DELETE",
          headers: {
            Cookie: cookieStore.toString(),
  ...
  deleteSubject: async (categoryId: string) => {
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/categories/delete/subject/${categoryId}`,
        {
          method: "DELETE",
          headers: {
            Cookie: cookieStore.toString(),
