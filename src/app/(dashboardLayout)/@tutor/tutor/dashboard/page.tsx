...
export default async function TutorDashboardOverview() {
  ...
  console.log("Tutor Response:", tutorRes?.data);
      ...
      <div className="max-w-6xl mx-auto space-y-6">
              ...
              {!recentReviews || recentReviews.length === 0 ? (
                ...
                recentReviews.map((rev) => (
                  ...
                  >
                    <Avatar className="w-9 h-9">
                      <AvatarImage
                        src={rev?.student?.image ?? undefined}
                      />
        ...
        <Card>
          <CardHeader className="pb-3 pt-5 px-5">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {availability?.activeSlots || 0} active slot
              {availability?.activeSlots !== 1 ? "s" : ""} of{" "}
              {availability?.total || 0} total
            </p>
          </CardHeader>
