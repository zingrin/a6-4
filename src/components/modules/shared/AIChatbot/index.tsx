...
const QUICK_ACTIONS = [
  {
    ...
    prompt: "What are the most popular courses right now?",
  },
  {
    label: "Suggest for me",
    prompt: "Can you suggest some courses I might like?",
  },
  ...
  const [messages, setMessages] = useState<IChatMessage[]>([
    {
      role: "assistant",
      content:
        "Hello! I'm SkillBridge AI. How can I help you accelerate your learning today?",
    },
  ]);
          ...
          >
                        ...
                        components={{
                          ...
                          a: ({ href, children }) => (
                            <a
                              ...
                              className="text-primary underline hover:opacity-80 break-all font-medium"
                            >
                              {children}
                            </a>
                          ),
            ...
            <div className="p-4 border-t border-border bg-background/80 backdrop-blur-sm space-y-4">
              ...
              <p className="text-[10px] text-center text-muted-foreground opacity-60">
                SkillBridge AI can make mistakes. Verify important info.
              </p>
            </div>
          </motion.div>
        )}
